"""
TiDB LOAD DATA operations test suite.

This test file contains comprehensive tests for TiDB load data functionality including
LOAD DATA, CSV/TSV error handling, duplicate keys, column mapping, charset,
